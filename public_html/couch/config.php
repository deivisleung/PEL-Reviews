<?php
    ...
    //define( 'K_SITE_URL', 'https://pelreviews.000webhostapp.com' );
    ...
    define( 'K_DB_NAME', 'id5234286_test' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'id5234286_admin' );
    // 6.
    // Database password
    ...
    define( 'K_COMMENTS_INTERVAL', 1 * 60 );
