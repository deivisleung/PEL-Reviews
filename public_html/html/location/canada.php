...
<cms:template title='Canada' clonable='1' commentable='1'>
    <cms:editable name='can_content' type='richtext' />
    <cms:editable name='can_image'
        crop='1'
        width='610'
        height='150'
        type='image'
       ...
       <div class="collapse navbar-collapse" id="navbarsExampleDefault">
         <ul class="navbar-nav mr-auto">
           ...
           <li class="nav-item dropdown">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdown01">
               <a class="dropdown-item" href="unitedstates.php">United States</a>
               <a class="dropdown-item" href="mexico.php">Mexico</a>
        ...
        <div class="row">
            <div class="col-md-8 blog-main">
                <div class="blog-post">
                    ...
                    <a href="#">Canada</a> &bull; 
                    <cms:show k_page_date format='js M, y'/> &bull;
                    <a href="#"><cms:show k_comments_count /> Comments</a>
                    
                    <img class="thumb" src="<cms:show can_image />" alt=""/>
                    
                    <cms:show can_content />
