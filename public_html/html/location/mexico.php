...
<cms:template title='Mexico' clonable='1' commentable='1'>
    <cms:editable name='mex_content' type='richtext' />
    <cms:editable name='mex_image'
        crop='1'
        width='610'
        height='150'
        type='image'
        ...
        <div class="row">
            <div class="col-md-8 blog-main">
                <div class="blog-post">
                    ...
                    <a href="#">Mexico</a> &bull; 
                    <cms:show k_page_date format='js M, y'/> &bull;
                    <a href="#"><cms:show k_comments_count /> Comments</a>
                    
                    <img class="thumb" src="<cms:show mex_image />" alt=""/>
                    
                    <cms:show mex_content />
