...
<cms:template title='United States' clonable='1' commentable='1'>
    <cms:editable name='usa_content' type='richtext' />
    <cms:editable name='usa_image'
        crop='1'
        width='610'
        height='150'
        type='image'
        ...
        <div class="row">
            <div class="col-md-8 blog-main">
                <div class="blog-post">
                    ...
                    <a href="#">United States</a> &bull; 
                    <cms:show k_page_date format='js M, y'/> &bull;
                    <a href="#"><cms:show k_comments_count /> Comments</a>
                    
                    <img class="thumb" src="<cms:show usa_image />" alt=""/>
                    
                    <cms:show usa_content />
