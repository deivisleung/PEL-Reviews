...
<cms:template title='Books' clonable='1' commentable='1'>
    <cms:editable name='book_content' type='richtext' />
    <cms:editable name='book_image'
        crop='1'
        width='610'
        height='150'
        type='image'
 ...
 <body>
        ...
        <div class="row">
            <div class="col-md-8 blog-main">
                <div class="blog-post">
                    ...
                    <img class="thumb" src="<cms:show book_image />" alt=""/>
                    
                    <cms:show book_content />
  ...
  <footer class="page-footer font-small stylish-color-dark pt-4 mt-4">
    ...
    <div class="footer-copyright py-3 text-center">
      © 2018 Copyrigfffffffht:
      <a href="index.php"> PELReviewsfffffffffffff.com </a>
    </div>
  </footer>
  <!--/.Footer-->
